...
namespace ProgressTable.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Порохов Илья Вячеславович", Visual=2, Architecture=2, Networks=2, Calculate_Math=2, PI=2, Math=2, Electric=2},
                new Student{Name="Репкин Владимир Ильич", Visual=2, Architecture=2, Networks=2, Calculate_Math=2, PI=2, Math=2, Electric=2},
            };
            CheckAverage(students);
